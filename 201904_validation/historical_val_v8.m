...
plot(time_wrf,ws_wrf,'linewidth',2,'displayname','WRF 3.6')
...
fname = sprintf('output/buoy%s_WRF4_WRF3_WRFrt_comparison_%s_%s',point,datestr(wrf_dtime(ind(1)),29),datestr(wrf_dtime(ind(end)),29));
