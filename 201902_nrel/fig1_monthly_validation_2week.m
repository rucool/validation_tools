...
% Select a Station
buoy = '44025';
end_date = datenum(2019,2,12);
start_date = addtodate(end_date,-14,'day');
...
% Load Model Data
dfile = 'nrel_20150601_20150630.nc';
...
% Load Buoy Data
ndbc_url = 'http://dods.ndbc.noaa.gov//thredds/dodsC/data/stdmet/44025/44025h9999.nc';
