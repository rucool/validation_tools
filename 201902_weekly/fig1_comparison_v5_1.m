...
dfile = 'v41_2w_W41_20190710_20190723.nc';
end_date = datenum(2019,7,23);
total_days = 13;
...
plot(wrf_dtime,wrf_ws,'r','linewidth',.8,'displayname','WRF 4.1');
...
xlim([datenum(2019,07,10) end_date])
grid on;
...
fname = sprintf('output/buoy_nams_gfs_v41_comparison_%s_%s_%s',buoy,datestr(start_date(1),29),datestr(end_date(end),29));
...
outfile = sprintf('output/metrics_all_v41_%s_%s_%s.csv',buoy,datestr(start_date,29),datestr(end_date,29));
fid = fopen(outfile,'w');
